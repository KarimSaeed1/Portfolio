...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      color: "tech-purple",
      skills: ["MongoDB", "PostgreSQL", "MySQL", "GraphQL", "NoSQL", "SQL", "Firebase", "Redis"]
    },
    {
    ...
    },
    {
      ...
      color: "warning",
      skills: ["Visual Studio", "VS Code", "Postman", "Unit Testing", "Microsoft Office Suite", "Debugging", "Claude & ChatGpt", "Automated Testing", "Swagger"]
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Computer Science & Methodologies",
      color: "destructive",
      skills: ["Data Structure", "Algorithms", "Problem Solving", "Agile", "Software Design", "OOP", "Design Patterns", "Creative Thinking", "Database Design", "Workflow Automation"]
    }
  ];
