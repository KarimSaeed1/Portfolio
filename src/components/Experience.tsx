...
const Experience = () => {
  const experiences = [
      ...
      type: "Full-time",
      about: "Consulting agency that offering software solutions and Business development, a company specialized in the field of software and software solutions in helping companies develop through our own programs, products and services. We also specialize in preparing facilities to obtain ISO certificates.",
      description: "3 years of experience designing, building, and optimizing scalable backend systems for enterprise applications, real-time platforms, and cloud-based solutions. Strong expertise in Node.js, Express.js, MongoDB, PostgreSQL, and AWS, with a proven ability to develop high-performance RESTful APIs, microservices, and real-time applications (Socket.IO).",
      achievements: [
        "Backend Development – Built 15+ projects including e-commerce platforms, HR systems, real estate portals, and medical/LIMS software with secure authentication (JWT, OAuth, MFA)",
        "Database & Optimization – Designed and managed SQL/NoSQL databases (MongoDB, PostgreSQL, MySQL), conducted migrations, and improved query performance",
        "System Architecture – Developed modular, testable, and scalable backend systems using TypeScript, Prisma ORM, and unit testing (Jest, Mocha)",
        "Cloud & DevOps – Deployed CI/CD pipelines (Git, Docker) and cloud services (AWS S3, Firebase) for high-availability applications",
        "Leadership & Collaboration – Led backend development, mentored junior developers, and worked with cross-functional teams"
      ],
      notableProjects: [
        {
          name: "Ayat Workflow",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          {experiences.map((experience, idx) => (
            <Card key={idx} className="glass-effect animate-slideInUp">
              <CardContent className="p-8">
                ...
                {experience.about && (
                  <div className="mb-8">
                    <h4 className="text-lg font-semibold mb-4">About {experience.company}:</h4>
